...
function zapisiopen() {
    ...
    document.getElementsByClassName('firstcontainer')[0].style.display = "inline-block";
    document.getElementsByClassName('secondcontainer')[0].style.display = "inline-block";
...
function mastersclick() {
    ...
    document.getElementsByClassName('secondcontainer')[0].style.display = "none";
...
function nextclick(){
    if ($(".allcontainerforchoise").find(".check1:checked")) {
        ...
        if (buttonforspecclicked == true) {
            ...
            massiv[1] = week;
            massiv[2] = 0;
            $('.allcontainerforchoise .check1:checked').each(function () {
                if ($(this).attr('id') == "checknumber1") {
                    massiv[2] += 1;
                };
                if ($(this).attr('id') == "checknumber2") {
                    massiv[2] += 2;
                };
                if ($(this).attr('id') == "checknumber3") {
                    massiv[2] += 2;
                };
                if ($(this).attr('id') == "checknumber4") {
                    massiv[2] += 4;
                };
                if ($(this).attr('id') == "checknumber5") {
                    massiv[2] += 2;
                };
            ...
            jsonforparticalviewforzapisi(json);
            dataforzapisbd[0] = mastername;
            dataforzapisbd[1] = 0;
            dataforzapisbd[6] = "";
            //dataforzapisbd[1] = week;
            $('.allcontainerforchoise .check1:checked').each(function () {
                if ($(this).attr('id') == "checknumber1") {
                    dataforzapisbd[1] += 1;
                    dataforzapisbd[6] += "стрижка.";
                };
                if ($(this).attr('id') == "checknumber2") {
                    dataforzapisbd[1] += 2;
                    dataforzapisbd[6] += "окрашиваниев1тон.";
                };
                if ($(this).attr('id') == "checknumber3") {
                    dataforzapisbd[1] += 2;
                    dataforzapisbd[6] += "биозавивка.";
                };
                if ($(this).attr('id') == "checknumber4") {
                    dataforzapisbd[1] += 4;
                    dataforzapisbd[6] += "сложноеокрашивание.";
                };
                if ($(this).attr('id') == "checknumber5") {
                    dataforzapisbd[1] += 2;
                    dataforzapisbd[6] += "мелирование.";
                };
